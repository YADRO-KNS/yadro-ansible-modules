...
.. _ansible_collections.yadro.obmc.system_boot_settings_module:
...
yadro.obmc.system_boot_settings module -- Setup Host OS boot settings.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`yadro.obmc.system_boot_settings`.
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.yadro.obmc.system_boot_settings_module__parameter-connection:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.yadro.obmc.system_boot_settings_module__parameter-connection/hostname:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.yadro.obmc.system_boot_settings_module__parameter-connection/password:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.yadro.obmc.system_boot_settings_module__parameter-connection/port:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.yadro.obmc.system_boot_settings_module__parameter-connection/session_key:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.yadro.obmc.system_boot_settings_module__parameter-connection/timeout:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.yadro.obmc.system_boot_settings_module__parameter-connection/username:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.yadro.obmc.system_boot_settings_module__parameter-connection/validate_certs:
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-override_enabled"></div>

      .. _ansible_collections.yadro.obmc.system_boot_settings_module__parameter-override_enabled:
      ...
      **override_enabled**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-override_enabled" title="Permalink to this option"></a>
    ...
    - .. raw:: html
      ...
      This property shall contain \ :literal:`Once`\  for a one-time boot override, and \ :literal:`Continuous`\  for a

      remain-active-until-cancelled override. If set to \ :literal:`Once`\ , the value is reset to \ :literal:`Disabled`\  after the

      \ :emphasis:`override\_target`\  actions have completed successfully. Changes to this property do not alter the BIOS
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-override_mode"></div>

      .. _ansible_collections.yadro.obmc.system_boot_settings_module__parameter-override_mode:
      ...
      **override_mode**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-override_mode" title="Permalink to this option"></a>
    ...
    - .. raw:: html
      ...
      The BIOS boot mode to use when the system boots from the \ :emphasis:`override\_target`\  boot source.
  ...
  * - .. raw:: html
        ...
        <div class="ansible-option-cell">
        <div class="ansibleOptionAnchor" id="parameter-override_target"></div>

      .. _ansible_collections.yadro.obmc.system_boot_settings_module__parameter-override_target:
      ...
      **override_target**
      ...
      .. raw:: html
        ...
        <a class="ansibleOptionLink" href="#parameter-override_target" title="Permalink to this option"></a>
    ...
    - .. raw:: html
      ...
      \ :literal:`Pxe`\  indicates to PXE boot from the primary NIC

      \ :literal:`Cd`\ , \ :literal:`Usb`\ , and \ :literal:`Hdd`\  indicate to boot from their devices respectively.

      \ :literal:`BiosSetup`\  indicates to boot into the native BIOS screen setup.

      \ :literal:`Diags`\  indicate to boot from the local utilities or diags partitions.
      ...
      - :ansible-option-choices-entry:`Diags`
      - :ansible-option-choices-entry:`BiosSetup`
      - :ansible-option-choices-entry:`Usb`
...
.. list-table::
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.yadro.obmc.system_boot_settings_module__return-error:
  ...
  * - .. raw:: html
      ...
      .. _ansible_collections.yadro.obmc.system_boot_settings_module__return-msg:
